...
#2 conditions are needed to be checked :1-no is prime 2-it is a factor of n
from math import *
t=eval(raw_input())
...
for k in range(t):
	n=eval(raw_input())
	i=3   #started from 3 an is incremented by 2 so as to avoid even no prime checking as 2 is the only prime no
	maxi=0
